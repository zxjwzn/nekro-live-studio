...
class BreathingController(BaseController):
    ...
    async def run_cycle(self):
        ...
        inhale_dur = self.cfg.inhale_duration + random.uniform(
            -self.cfg.inhale_duration * jitter_dur,
            self.cfg.inhale_duration * jitter_dur,
        )
        exhale_dur = self.cfg.exhale_duration + random.uniform(
            -self.cfg.exhale_duration * jitter_dur,
            self.cfg.exhale_duration * jitter_dur,
        )
